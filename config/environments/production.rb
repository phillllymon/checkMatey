Rails.application.configure do
  ...
  # Render blocks/times out on outbound raw SMTP, so mail goes through
  # SendGrid's HTTPS API instead (see lib/sendgrid_delivery_method.rb).
  ...
  # config.active_job.queue_name_prefix = "checkMatey_#{Rails.env}"
